...
- **操作系统版本**：Windows 11
- **工作区路径**：E:\RedMi_E盘_person\code\ramble-uav\uav-integration
- **代码作者**：cml
- **当前时间**：2025-11-28 13:32:38
...
- 使用 `@Valid` 与 JSR-303 校验注解（如 `@NotBlank`, `@Size` 等）
  - 注意：Spring Boot 2.7.6 中校验注解位于 `javax.validation.constraints.*`
...
- 所有类、方法、字段需添加 **Javadoc** 注释。使用中文进行注释。
